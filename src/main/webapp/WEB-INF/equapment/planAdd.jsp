...
function check(){
	...
	if(Trim(theForm.devName.value)==""){
	 ...
	 if(window.opener)
	{
		document.Form1.action="saveDevicePlan.do";
			...
			<table cellSpacing="1" cellPadding="5" width="700" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="devName" type="text" maxlength="50" id="devName" size="19" >&nbsp;<font color="#FF0000">*</font>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="trademark" type="text" maxlength="25" id="trademark" size="19" >&nbsp;<!-- font color="#FF0000">*</font -->
					</td>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						规格型号：
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="quality" type="text" maxlength="10" style="text-align:left" id="quality" style="width:40" value="" onblur='checkNumber(this)'>
						<input name="qunit" type="text" maxlength="5" id="qunit" style="width:105" value="">&nbsp;<font color="#FF0000">*</font></td>
				...
				<tr>
					...
					<td class="ta_01" bgcolor="#ffffff" width="277">
						<input name="planDate" type="text" size="19" id="planDate" onclick="WdatePicker()">&nbsp;<font color="#FF0000">*</font>
					</td>
