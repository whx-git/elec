           ...
           <table border="0" width="100%" cellspacing="0" cellpadding="0">
               <tr>
                  ...
                  <select size="15" name="colname1" multiple style="width:200px" id="colname1" ondblclick="JavaScript:Add('colname1','colname2','colname')">
                         ...
                         <option value="sor.Record" >校准记录</option>
                         ...
                         <option value="convert(varchar(10),AdjustPeriod+APUnit) as jiaozhun" >校准周期</option>
                   
                         <option value="case sd.APState when  '1' then '已校准' else '未校准' end as jiaozhunstate" >校准状态</option>
                   ...
                   <select size="15" name="colname2" id="colname2" multiple style="width:200px" ondblclick="JavaScript:Remove('colname1','colname2','colname')">
                           ...
                           <option value="case when sor.startdate is null then convert(varchar(10),'',120) else convert(varchar(100),sor.startdate,23) end as startdate" >校准日期</option>
