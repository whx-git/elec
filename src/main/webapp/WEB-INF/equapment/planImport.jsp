...
<form name="importForm" method="post" action="/planImport.html" enctype="multipart/form-data">
      <br>
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="83%" align="left"><input type="file" name="files" value="" style="width:365px" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"></td>
          <td width="1%"></td>
        </tr>
