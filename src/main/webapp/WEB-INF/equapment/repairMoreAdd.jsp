 ...
 function check(){
	 ...
	 for (var i=0;i<dtype.Form1.elements.length;i++)
	 {
	  ...
	  if(id!=""){
		...
		document.Form1.action="moreUpdateDeviceJ.do";
  ...
  function getdevTypeChange(dt){
      ...
      document.all.dtype.src="repairMoreAddList.jsp?findFlag=1&devType="+dt.value;
  }
...
<body ms_positioning="GridLayout"  onunload="submitrequest('clearSession.do?action=J')">

<form name="Form1" method="post" >
							<input type="hidden" name="devId" id="devId" value="3"> 
                      &nbsp;  
			     ...
			     <tr>
					...
					<option value="" >全部</option>
										...
										<tr>
											...
											<input type="button" name="chkall" style="font-size:12px; color:#000000; background-color:#f5fafe; border:0px;  height="10"" value="全选" onClick="CheckAll(this.form)"> 
				 |&nbsp;
<input type="button"  style="font-size:12px; color:#000000; background-color:#f5fafe; border:1px; height="18"" name="chkOthers" value="取消" onClick="CheckOthers(this.form)" ></td>
										</tr>
										<tr>
											<td colspan="2">
											<IFRAME src="repairMoreAddList.jsp?findFlag=1&devType=
		" name="dtype" id="dtype" frameBorder=0 width=335 scrolling=auto height=220></IFRAME></td>
										</tr>
									</table>
									</fieldset></td>
									...
									<table cellSpacing="1" width=100% cellPadding="5" height="320" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0" >
										...
										<tr>
											...
											<td bgColor="#f5fafe" class="ta_01"><input name="startDate" type="text" class="bg" id="startDate" onclick="WdatePicker()" size="10" readonly>&nbsp;<font color="#FF0000">*</font></td>
										</tr>
...
<select   name="isHaving" id="isHaving" class="bg" style="width:50"  name=ifshare onChange=shareOnChange(this)>
  ...
  <input style="font-size:12px; color:black; height=22;width=55"  id="BT_Add" type="button" value="详细" name="BT_Add" onClick="openWindowWithName('repairFile.jsp',800,450,'EOC');" />
  </span></td>
										</tr>
										<tr>
			  ...
			  <input type="button" name="BT_Submit22" value="保存" id="BT_Submit22" style="font-size:12px; color:black; height=22;width=55"   onclick="returnMethod()">&nbsp;&nbsp;
