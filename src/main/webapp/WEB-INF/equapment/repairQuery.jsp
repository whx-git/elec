	...
	<BR>
		<form name="Form1" method="post">							
			...
			<table cellSpacing="1" cellPadding="5" width="600" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
				...
				<tr>
					<td class="ta_01" align="center" background="${pageContext.request.contextPath }/images/b-info.gif" colspan="8">
						<font face="宋体" size="2">
						<strong>设备检修历史记录							
						</strong>
						</font>
						...
						style="BORDER-RIGHT:gray 1px solid; BORDER-TOP:gray 1px solid; BORDER-LEFT:gray 1px solid; WIDTH:100%; WORD-BREAK:break-all; BORDER-BOTTOM:gray 1px solid; BORDER-COLLAPSE:collapse; BACKGROUND-COLOR:#f5fafe; WORD-WRAP:break-word">
							<tr style="FONT-WEIGHT:bold;FONT-SIZE:12pt;HEIGHT:25px;BACKGROUND-COLOR:#afd1f3">								  
					              <td align="center" width="15%" height=22 background="${pageContext.request.contextPath }/images/tablehead.jpg">设备名</td>
						      	  <td align="center" width="11%" height=22 background="${pageContext.request.contextPath }/images/tablehead.jpg">检修日期</td>
					              <td align="center" width="11%" height=22 background="${pageContext.request.contextPath }/images/tablehead.jpg">所属单位</td>
								
								<td align="center" width="8%" background="${pageContext.request.contextPath }/images/tablehead.jpg" height=21>编辑</td>
							...
							<tr>
								...
								<td style=CURSOR:hand;  align=center  width=8%>
									...
									<a href="javascript:;" onClick="EditDetail('repairEdit.jsp?liu=1&devId=ab15b1290c004d53af24bd2ce8845fa4&seqId=7307')" class="cl_01">编辑</a>  
