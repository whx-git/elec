...
<form id="Form1" name="Form1" action="/queryData.html" method="post" style="margin:0px;">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
		     ...
		     <tr>
		        <td class="ta_01" align="center" bgcolor="#f5fafe" height="22">
		           按文件名称和描述搜素：</td>
		          <td class="ta_01">
		          	<input type="text" name="queryString" size="21" value="" id="queryString" onkeydown="returnMethod()"/>
		          </td>
  ...
  <table cellspacing="0" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
	<TR>
		...
		<td class="ta_01" align="right" bgcolor="#ffffff">
			...
			<input  id="BT_Add" type="button" value="添加" name="BT_Add" style="font-size:12px; color:black; height=20;width=50"   onclick="openWindow('dataChartAdd.html',800,400);">
				...
				<tr style="FONT-WEIGHT:bold;FONT-SIZE:12pt;HEIGHT:25px;BACKGROUND-COLOR:#afd1f3">
					...
					<c:forEach items="${elecFileuploads}" var="upload" varStatus="vs">
						<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
							<td  align="center" width="6%">${vs.count}</td>
							<td align="center"  width="10%">${upload.projid}</td>
							<td align="center"  width="10%">${upload.belongto}</td>
							<td align="center"  width="48%">
								<a href="#" onclick="openWindow('${upload.fileurl}','700','400');">${upload.filename}</a></td>
							<td align="center"  width="20%">${upload.comment}</td>
