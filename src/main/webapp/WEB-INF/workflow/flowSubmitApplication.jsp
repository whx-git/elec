			...
			<table border="0" width="90%" cellspacing="1" cellpadding="0" align="center" bgcolor="#f5fafe">
				...
				<tr>
			        ...
			        <td class="ta_01" bgColor="#ffffff" colspan="3">
			        	<a id="saveElecApplication" href="${pageContext.request.contextPath }/workflow/elecApplicationTemplateAction_download.do?id=1" style="text-decoration: underline">[点击下载申请模板文件]</a>
			        </td>
				</tr>
				<tr height=10>
					<td colspan=4></td>
				...
				<tr>
			        ...
			        <td class="ta_01" bgColor="#ffffff" colspan="3">
			        	<select name="checkLogonName" id="checkLogonName" style="width:155px">
						    <option value="">请选择</option>
						    <option value="lisisi">李四四</option>
