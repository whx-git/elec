...
<Script language="javascript">
	function check_null(){
	   ...
	   document.Form1.action="jctBuildAdd.do";
...
<tr> 
  ...
  <td width="35%"width="35%" class="ta_01" bgColor="#ffffff"><input name="buildName" type="text" id="buildName"  size="20" maxlength="25">&nbsp;<font color="#FF0000">*</font></td>
...
<tr> 
  ...
  <td width="35%" class="ta_01" bgColor="#ffffff"><input name="buildLayer" type="text" id="buildLayer"  size="20" maxlength="25"></td>
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">建筑面积：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff"><input name="buildArea" type="text" id="buildArea"  size="20" maxlength="25">m<sup>2</sup>&nbsp;&nbsp;<font color="#FF0000">*</font></td>
    </tr>
<tr> 
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">始建时间：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff"><input name="buildStartDate" type="text" id="buildStartDate"  size="20" onClick="WdatePicker()"></td>
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">扩建时间：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff"><input name="extendBuildDate" type="text" id="extendBuildDate"  size="20" onClick="WdatePicker()"></td>
  </tr>
<tr> 
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">扩建面积：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff"><input name="extendBuildArea" type="text" id="extendBuildArea"  size="20" maxlength="25">m<sup>2</td>
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">大修时间：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff"><input name="dxDate" type="text" id="dxDate"  size="20" onClick="WdatePicker()"></td>
  </tr>
<tr> 
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">造&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff"><input name="buildExpense" type="text" id="buildExpense"  size="20" maxlength="10">万元</td>
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">使用时间：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff"><input name="useDate" type="text" id="useDate"  size="20" onClick="WdatePicker()"></td>
  </tr>
<tr>
	<td width="15%" class="ta_01" align="center" bgcolor="#f5fafe">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</td>
	<td width="85%" class="ta_01" bgcolor="#ffffff" colspan="3">
		<textarea name="comment" id="comment" style="WIDTH:92%" rows="4" cols="52"></textarea></td>
</tr>
