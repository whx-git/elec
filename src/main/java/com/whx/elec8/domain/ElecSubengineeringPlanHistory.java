...
public class ElecSubengineeringPlanHistory {
    private String ssepid;
    ...
    public String getSsepid() {
        return ssepid;
    }

    public void setSsepid(String ssepid) {
        this.ssepid = ssepid == null ? null : ssepid.trim();
    }
