...
function init(){
    ...
    obj.value=nowdate.getFullYear();
    document.Form1.sbMonth.value=nowdate.getMonth()+1;
...
function getStation(para){
 ...
 function check_null(){
	   ...
	   document.Form1.action="addRepairInfo.do";
   ...
   function refreshThisOpener(sHref){
      opener.gotopage(sHref,"addnewbug");  
      //window.close ();
   }
   ...
   function upload(fn){
       ...
       if(jctId==0){
		...
		openWindow('siteStateFile.jsp',str,800,450);
	}
	...
	<table cellspacing="1" cellpadding="5" width="580" align="center" bgcolor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
		...
		<tr>
			        <td colspan="4" class="ta_01" align="center" background="${pageContext.request.contextPath }/images/b-info.gif">
			         <font face="宋体" size="2"><strong>故障录入</strong></font>
			        </td>
		  </tr>
       <tr>
      ...
      <input name="stationCode" type="text" id="stationCode"  size=20 readonly></td>
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff">
			<input name="occurDate" type="text" id="occurDate" size=20 onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly> <font color="#FF0000">*</font>					
			</td>
		...
		<tr>
			...
			<textarea name="bugDescribe" id="bugDescribe" style="WIDTH:96%" rows="3"></textarea></td>
		</tr>
		...
		<tr>
			...
			<input name="resolveDate" type="text" id="resolveDate" size="20" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly>			
			</td>
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" colspan="3">
			<textarea name="resolveMethod" id="resolveMethod" style="WIDTH:86%" rows="3"></textarea>
			&nbsp;&nbsp;<span id=PResolve style="DISPLAY: ''"><input id="btnResolve" type="button" value=" 详细" name="btnResolve" onclick="upload('7');" style="font-size:12px; color:black; height=20"></span></td>
		</tr>
		...
		<tr>
			...
			<font face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font>&nbsp;<input style="font-size:12px; color:black; height=22;width=55" type="reset" value=" 关闭" id="Reset1" name="Reset1" onclick="window.close();">
