...
function init(){
     ...
     document.Form1.stationId.value="91e63bc0-102f-4314-9959-cc5ad357f15b";
     getStationInfo();
...
function check_null(){
   ...
   function upload(fn,jctId){
		var str= "siteStateFile.jsp?belongTo=" + fn
			+ "&jctId=" + jctId
			+ "&projid=bugid";
...
<tr>
            <input name="bugid" type="hidden" id="bugid" value="354">	
            <input name="runflag" type="hidden" id="bugid" value="null">
		...
		<tr>
			...
			<option value="13" selected="selected">海南</option>	
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff">
			<input name="occurDate" type="text" id="occurDate" size=20 onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="2008-12-10 21:12">					
		...
		<tr>
			...
			<textarea name="bugDescribe" id="bugDescribe" style="WIDTH:96%" rows="3">具体情况0</textarea></td>
		</tr>
		<tr>
			 <td colspan="4" class="ta_01" align="center" background="${pageContext.request.contextPath }/images/b-info.gif">
		...
		<tr>
			...
			<input name="resolveDate" type="text" id="resolveDate" size="20" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  value="2008-12-31 23:00">			
			</td>
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" colspan="3">
			<textarea name="resolveMethod" id="resolveMethod" style="WIDTH:86%" rows="3">具体情况7</textarea>
			&nbsp;&nbsp;<span id=PResolve style="DISPLAY: ''"><input id="btnResolve" type="button" value=" 详细" name="btnResolve" onclick="upload('7','13');" style="font-size:12px; color:black; height=20"></span></td>
		</tr>
