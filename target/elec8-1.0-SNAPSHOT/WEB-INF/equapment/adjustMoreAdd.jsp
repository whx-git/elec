...
function check(){
  ...
  function getdevTypeChange(dt){
      ...
      document.all.dtype.src="${pageContext.request.contextPath }/equapment/adjustMoreAddList.jsp?findFlag=0&devType="+dt.value;
  }
...
<input type="button"  style="font-size:12px; color:#000000; background-color:#f5fafe; border:1px; height="18"" name="chkOthers" value="取消" onClick="CheckOthers(dtype.form)" ></td>
		...
		" name="dtype" id="dtype" frameBorder=0 width=335 scrolling=auto height=220></IFRAME>
			  </td>
										</tr>
									</table>
									</fieldset></td>
