			...
			<table cellSpacing="1" cellPadding="5" width="700" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
			        <td class="ta_01" colSpan="4" align="center" background="${pageContext.request.contextPath }/images/b-info.gif">
			         <font face="宋体" size="2"><strong>购置计划</strong></font>
			        </td>
		         </tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="devName" type="text" maxlength="50" id="devName" size="19" value="${plan.devname}">&nbsp;<font color="#FF0000">*</font>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="trademark" type="text" maxlength="25" id="trademark" size="19" value="${plan.trademark}">&nbsp;<!-- font color="#FF0000">*</font -->
					</td>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						规格型号：
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="specType" type="text" maxlength="25" id="specType" size="19" value="${plan.spectype}">&nbsp;<!-- font color="#FF0000">*</font -->
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="produceHome" type="text" maxlength="25" id="produceHome" size="19" value="${plan.producehome}">
					</td>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input name="quality" type="text" maxlength="10" style="text-align:left" id="quality" style="width:40" value="${plan.quality}" onblur='checkNumber(this)'>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="useness" type="text" maxlength="25" id="useness" size="19" value="${plan.useness}">
					</td>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						产&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input name="produceArea" type="text" maxlength="25" id="produceArea" size="19" value="${plan.producearea}">
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="devExpense" type="text" maxlength="17" id="devExpense" size="19" value="${plan.devexpense}" onblur='checkDecimal(this)'> 元
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="useUnit" type="text" maxlength="25" id="useUnit" size="19" value="${plan.useunit}">&nbsp;<!-- font color="#FF0000">*</font -->
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgcolor="#ffffff" width="277">
						<input name="planDate" type="text" size="19" id="planDate" size="12" onclick="WdatePicker()" value="${plan.plandate}">&nbsp;<font color="#FF0000">*</font>
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="adjustPeriod" type="text" maxlength="4" id="adjustPeriod" size="12" value="${plan.adjustperiod}" onblur='checkNumber(this)'>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="overhaulPeriod" type="text" maxlength="4" id="overhaulPeriod" size="12" value="${plan.overhaulperiod}" onblur='checkNumber(this)'>
				...
				<tr>
					...
					<input type="hidden" name="devPlanId" value="${plan.jctid}">
