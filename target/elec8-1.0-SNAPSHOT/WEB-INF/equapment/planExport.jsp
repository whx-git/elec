  ...
  function Remove() {
   ...
   function setValue(){
     ...
     function checksubmit(){
       ...
       document.Form1.action="saveExportSetting.html";
           ...
           <table border="0" width="100%" cellspacing="0" cellpadding="0">
               <tr>
                  ...
                  <select size="15" name="colname1" multiple style="width:200px" id="colname1" ondblclick="JavaScript:Add('colname1','colname2','colname')">
                      ...
                      <c:forEach items="${defaltNoExportItems}" var="noItem">

                          <option value="${noItem.dbName}" >${noItem.excelName}</option>
                   ...
                   <select size="15" name="colname2" id="colname2" multiple style="width:200px" ondblclick="JavaScript:Remove('colname1','colname2','colname')">
                       <c:forEach items="${defaltExportItems}" var="item">
                           <option value="${item.dbName}" >${item.excelName}</option>
                       </c:forEach>
