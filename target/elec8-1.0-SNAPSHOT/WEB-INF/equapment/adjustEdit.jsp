...
<body onload="shareOnChange(document.Form1.isHaving)"  onunload="submitrequest('clearSession.do?action=X')">
...
<input name="devName" type="text" id="devName" size="19" value="UPS6666" disabled></font></td>									
			...
			<input name="seqId" type="hidden" id="seqId" size="19"  value="7313">	
			<input name="devId" type="hidden" id="devId" size="19"  value="e11c8381ec0f436b992ba0e44dd33cb0">							
...
<td width="100" class="ta_01" align="center" bgColor="#f5fafe" height="22">
									使用日期：</td>
									<td class="ta_01" bgColor="#ffffff"><font face="宋体" color="red">
<input name="useDate" type="text" id="useDate" size="19"  value="2007-05-27" disabled></font></td>
								</tr>
<tr>
<td width="153" class="ta_01" align="center" bgcolor="#f5fafe" height="22">
					设备类型：</td>
...
<td width="100" class="ta_01" align="center" bgColor="#f5fafe" height="22">校准状态：</td>
									<td class="ta_01" bgColor="#ffffff" width="224">
									<select name="apstate" id="apstate" class="bg"  disabled>
...
<td class="ta_01" align="center" bgcolor="#f5fafe" height="22">
					...
					<input disabled name="startDate" type="text" size="19"  id="startDate" disabled value="2017-06-05"></font>&nbsp;<font color="#FF0000">*</font></td>
...
<select name="isHaving" id="isHaving" class="bg" style="width:50"   onChange=shareOnChange(this)>
  ...
  <input style="font-size:12px; color:black; height=22;width=55" id="BT_Add" type="button" value="详细" name="BT_Add" onClick="openWindowWithName('adjustFile.jsp?liu1=1&devId=e11c8381ec0f436b992ba0e44dd33cb0&projId=7313',800,450,'ECC');" />
  </span>
</TD>
</TR>
...
<TD class="ta_01" bgColor="#ffffff" colSpan="3">
<textarea name="comment" id="comment" style="WIDTH:96%" rows="3"></textarea></TD>
</TR>
	<tr>
...
<tr>
	...
	<input type="button" name="BT_Submit" value="修改" id="BT_Submit" style="font-size:12px; color:black; height=22;width=55"  onclick="returnMethod()"/>
	<FONT face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>
