...
<td width="100" class="ta_01" align="center" bgColor="#f5fafe" height="22">
									使用日期：</td>
									<td class="ta_01" bgColor="#ffffff"><font face="宋体" color="red">
<input name="TB_timeW" type="text" id="TB_timeW" size="19" value="2017-04-28" disabled></font></td>
								</tr>
<tr>
<td width="153" class="ta_01" align="center" bgcolor="#f5fafe" height="22">
					设备类型：</td>
...
<td class="ta_01" align="center" bgcolor="#f5fafe" height="22">
					...
					<input name="startDate" type="text" size="19"  id="startDate" disabled value="2017-06-30"></font>&nbsp;<font color="#FF0000">*</font></td>
