...
<body onload="ini()">
<form action="/login.html" method="post" target="_top">
						...
						<td height="99" width="27%">
							<table border="0" width="70%" id="table4">
								...
								<tr>
									...
									<td><input type="password" name="password" style="width: 125 px" size="20" value="admin"  maxlength="25"></td>
								...
								<tr>
									<td width="100"></td>
									<td width="100"><input type="button" class=btn_mouseout onmouseover="this.className='btn_mouseover'" onmouseout="this.className='btn_mouseout'" value="登   录" name="huifubtn" onclick="checkFunction()">
									<span style="color:red"> ${resultInfo}</span></td>
