...
<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath }/workflow/flowMyTaskList.jsp" method="post" style="margin:0px;"> 
			<table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
				<TR height=10><td></td></TR>
				<tr>
					<td class="ta_01" colspan=2 align="center" background="../images/b-info.gif">
						<font face="宋体" size="2"><strong>待我审批管理</strong></font>
					</td>
								...
								<td width="12%" align="center" height=22 background="${pageContext.request.contextPath }/images/tablehead.jpg">查看流程记录</td>
									...
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										<td style="HEIGHT:22px" align="center" width="30%">
											设备购置计划模板;_张三_2017-02-26 22:58:46
										</td>
										...
										<td style="HEIGHT:22px" align="center" width="10%">
											<a id="Form2_" href="${pageContext.request.contextPath }/workflow/flowApprove.jsp?applicationID=2&taskID=60006"><img src="${pageContext.request.contextPath }/images/handle.gif" width="16" height="16" border="0" style="CURSOR:hand"></a>												
										</td>
										<td style="HEIGHT:22px" align="center" width="12%">
											<a id="Form2_" href="${pageContext.request.contextPath }/workflow/flowApprovedHistory.jsp?applicationID=2"><img src="${pageContext.request.contextPath }/images/button_view.gif" border="0" style="CURSOR:hand"></a>													
										</td>
									</tr>
						</table>		
					</td>
