		...
		<form name="Form1" action="workflow/elecApplicationFlowAction_approve.do" method="post">
			...
			<table border="0" width="90%" cellspacing="1" cellpadding="0" align="center" bgcolor="#f5fafe">
				...
				<tr>
			        ...
			        <td class="ta_01" bgColor="#ffffff" colspan="3">
			        	<select name="outcome" id="outcome" style="width:155px" onchange="checkUser()">
						    <option value="to 审批【总经理】">to 审批【总经理】</option>
						    <option value="to 结束">to 结束</option>
						</select>
			        </td>
				</tr>
				<tr id="trCheck">
			        ...
			        <td class="ta_01" bgColor="#ffffff" colspan="3">
		        		<select name="checkLogonName" id="checkLogonName" style="width:155px">
						    ...
						    <option value="wangwuwu">王呜呜</option>
