						...
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
								<td style="HEIGHT:22px" align="center" colspan="5">
									<div>
										<a style="CURSOR:hand" href="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_approvedHistoryPic.do?applicationID=${applicationID}" onclick="return hs.htmlExpand(this, { contentId: 'highslide-html-1', objectType: 'ajax', preserveContent: true} )">
